...
* Refreshed plugin directory banner and icon artwork.
* Confirmed compatibility through WordPress 7.1.

= 1.2.2 =
* Updated readme with About BePlus section and landing page link
