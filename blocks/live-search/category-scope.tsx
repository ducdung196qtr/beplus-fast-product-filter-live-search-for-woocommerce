...
export default function CategoryScope( {
	...
	if ( categories.length === 0 ) {
		return (
			<p className="components-base-control__help">
				{ __( 'No product categories found.', 'beplus-fast-product-filter-live-search-for-woocommerce' ) }
			</p>
		);
	}
	...
	return (
		<>
			<FormTokenField
				label={ __( 'Categories', 'beplus-fast-product-filter-live-search-for-woocommerce' ) }
